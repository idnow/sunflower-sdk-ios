...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SunflowerUIKit",
            url: "https://github.com/idnow/sunflower-sdk-ios/releases/download/1.4.8/SunflowerUIKit.xcframework.zip",
            checksum: "d2e14e8e6a8d34a5006da01398eb11daa16b19529482258f1088eb52d23ebb8e"
        ),
        .target(
