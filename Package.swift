...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SunflowerUIKit",
            url: "https://github.com/idnow/sunflower-sdk-ios/releases/download/1.4.5/SunflowerUIKit.xcframework.zip",
            checksum: "30b1452c963799ba62f8288adcf0f83c0537ed06035b11c5dc6a9051730a4531"
        ),
        .target(
